/**
 * Enumerates the kinds of Dataplex resources that can be referenced by an
 * alias. The string values match the prefixes used in resource definitions
 * (e.g. `aspect: ...`, `entryLink: ...`).
 */
...
/**
 * Provides a 1:1 mapping between an alias and a fully-qualified resource,
 * combining a set of predefined defaults with user-supplied custom aliases.
 * Used to translate short aliases to resource names and back.
 */
