...
description: A simulated retail banking dataset modeling customers, accounts,
  transactions, and loans for testing the OKF projector mechanism.
tags:
  - financial-data
  - demo-dataset
  - cymbal-bank
...
catalogEntry:
  name: bigquery/royston-dev-8253/cymbal_bank_v6z_scaffold_demo_copy
  resource:
    name: https://bigquery.googleapis.com/v2/projects/royston-dev-8253/datasets/cymbal_bank_v6z_scaffold_demo_copy
  aspects:
    royston-dev-8253.us.okf:
      okf_type: BigQuery Dataset
      generated:
