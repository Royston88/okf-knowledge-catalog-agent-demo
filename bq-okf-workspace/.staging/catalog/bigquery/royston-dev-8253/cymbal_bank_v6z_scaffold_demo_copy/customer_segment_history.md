...
description: Historical log of customer tier assignments (retail, premier,
  private) over time using a Slowly Changing Dimension (SCD) Type 2 structure.
tags:
...
catalogEntry:
  name: bigquery/royston-dev-8253/cymbal_bank_v6z_scaffold_demo_copy/customer_segment_history
  resource:
    name: https://bigquery.googleapis.com/v2/projects/royston-dev-8253/datasets/cymbal_bank_v6z_scaffold_demo_copy/tables/customer_segment_history
  aspects:
