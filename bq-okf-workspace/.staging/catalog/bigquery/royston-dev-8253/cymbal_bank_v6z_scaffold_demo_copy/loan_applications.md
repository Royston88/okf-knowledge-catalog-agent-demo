...
description: Encompasses the application pipeline and lifecycle dates for bank
  loan products.
tags:
  - loans
  - applications
...
catalogEntry:
  name: bigquery/royston-dev-8253/cymbal_bank_v6z_scaffold_demo_copy/loan_applications
  resource:
    name: https://bigquery.googleapis.com/v2/projects/royston-dev-8253/datasets/cymbal_bank_v6z_scaffold_demo_copy/tables/loan_applications
  aspects:
    royston-dev-8253.us.okf:
      ...
      sources:
        - title: BigQuery Table Metadata for
            cymbal_bank_v6z_scaffold_demo_copy.loan_applications
