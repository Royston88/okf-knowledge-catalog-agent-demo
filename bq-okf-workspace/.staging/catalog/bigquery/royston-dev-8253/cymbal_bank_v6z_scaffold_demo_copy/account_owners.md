...
description: A junction table establishing the ownership mapping and roles
  between customers and bank accounts.
tags:
  - account-ownership
  - junction-table
  - customers
...
catalogEntry:
  name: bigquery/royston-dev-8253/cymbal_bank_v6z_scaffold_demo_copy/account_owners
  resource:
    name: https://bigquery.googleapis.com/v2/projects/royston-dev-8253/datasets/cymbal_bank_v6z_scaffold_demo_copy/tables/account_owners
  aspects:
