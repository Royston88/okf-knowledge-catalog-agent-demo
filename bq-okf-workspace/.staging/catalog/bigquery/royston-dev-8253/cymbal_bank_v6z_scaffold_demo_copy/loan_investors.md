...
description: A junction table that records the financial allocation and
  participation tier of institutional investors in loan applications.
tags:
  - loans
  - investors
  - allocations
...
catalogEntry:
  name: bigquery/royston-dev-8253/cymbal_bank_v6z_scaffold_demo_copy/loan_investors
  resource:
    name: https://bigquery.googleapis.com/v2/projects/royston-dev-8253/datasets/cymbal_bank_v6z_scaffold_demo_copy/tables/loan_investors
  aspects:
      ...
      sources:
        - id: royston-dev-8253-cymbal-bank-loan-investors
          title: BigQuery Table
            royston-dev-8253:cymbal_bank_v6z_scaffold_demo_copy.loan_investors
